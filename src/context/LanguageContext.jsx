...
export const translations = {
  id: {
    ...
    order: {
      ...
      hapusItem: "Hapus",
      hapusItemAria: "Hapus dari keranjang",
      tutup: "Tutup",
      satuan: "Satuan",
      kurangiQty: "Kurangi jumlah",
      tambahQty: "Tambah jumlah",
    },
    tentang: {
  ...
  en: {
    ...
    order: {
      ...
      hapusItem: "Remove",
      hapusItemAria: "Remove from cart",
      tutup: "Close",
      satuan: "Each",
      kurangiQty: "Decrease quantity",
      tambahQty: "Increase quantity",
    },
    tentang: {
      heroTitle: "About Us",
